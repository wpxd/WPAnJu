...
@implementation CusstomPageView
- (instancetype)init
{
    self = [super init];
    if (self)
...
//    _contentView.backgroundColor = [UIColor colorWithRed:0.98 green:0.98 blue:0.98 alpha:1];
    ...
    _contentView.layer.borderColor = [UIColorFromHex(0xff4800) CGColor];
...
//    _todayRecommendNumLab.backgroundColor = [UIColor yellowColor];
    ...
    _todayRecommendNumLab.textColor = UIColorFromHex(0x999999);
    _todayRecommendNumLab.text = @"0组";
...
//    chaKanLab.backgroundColor = [UIColor orangeColor];
    ...
    [_recommendBtn.layer setCornerRadius:10];
    ...
    _daiKanBtn.frame = CGRectMake(120, 0, 100, 35);
    [_daiKanBtn.layer setCornerRadius:10];
    _daiKanBtn.layer.borderWidth = 2;
    _daiKanBtn.layer.borderColor = [UIColorFromHex(0xff4800) CGColor];
    _daiKanBtn.titleLabel.font = [UIFont systemFontOfSize:16];
    [_daiKanBtn setTitleColor:UIColorFromHex(0xff4800) forState:UIControlStateNormal];
    [_daiKanBtn setTitle:@"带看扫码" forState:UIControlStateNormal];
