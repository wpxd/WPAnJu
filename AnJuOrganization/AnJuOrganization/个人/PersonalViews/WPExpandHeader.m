...
//
#define WPExpandContentOffset @"contentOffset"
#import "WPExpandHeader.h"

@implementation WPExpandHeader{
...
- (void)dealloc{
    if (_scrollView) {
        [_scrollView removeObserver:self forKeyPath:WPExpandContentOffset];
        _scrollView = nil;
    }
    _expandView = nil;
}
...
+ (id)expandWithScrollView:(UIScrollView*)scrollView expandView:(UIView*)expandView{
    WPExpandHeader *expandHeader = [WPExpandHeader new];
...
- (void)expandWithScrollView:(UIScrollView*)scrollView expandView:(UIView*)expandView{
    ...
    [_scrollView addObserver:self forKeyPath:WPExpandContentOffset options:NSKeyValueObservingOptionNew context:nil];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context{
    if (![keyPath isEqualToString:WPExpandContentOffset]) {
        return;
    }
