...
- (void)setOnClickBlock:(MBHudOnClickBlock)block {
    if(onClickBlock) [onClickBlock release];
    [onClickBlock release];
    onClickBlock = nil;
    if(block) {
        onClickBlock = [block copy];
    }
}
